      ...
      <div className="container mx-auto px-4 py-24">
        ...
        <div className="text-center space-y-6">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            A comprehensive platform that simplifies and streamlines your SaaS
            development, from prototype to production, with powerful
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-8">
          <Card>
            ...
            <CardContent>
              <p>
                ...
                authentication flows, and seamless integrations.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <p>
                Deploy instantly to Cloudflare Pages with built-in edge runtime
          ...
          <Card>
            ...
            <CardContent>
              <p>
                Seamless database management with Xata, providing type-safe and
        ...
        <div className="mt-16 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p>
                One-click deployments to Cloudflare with zero configuration.
              </p>
            </div>
            <div>
              ...
              <p>
                Built-in security best practices and edge runtime protection.
              </p>
            </div>
          </div>
        </div>
